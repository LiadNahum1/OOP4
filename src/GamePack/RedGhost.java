...
public class RedGhost extends Ghost {
	...
	public RedGhost(Pair initialPosition) {
	...
	private void updateDirsPic() { 
		...
		position.put("u", new ImageIcon("pictures/figures/red_u.png").getImage());
		position.put("l", new ImageIcon("pictures/figures/red_l.png").getImage());
		position.put("r", new ImageIcon("pictures/figures/red_r.png").getImage());
		position.put("d", new ImageIcon("pictures/figures/red_d.png").getImage());
